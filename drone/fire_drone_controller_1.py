...
from drone.fire_drone_controller_2 import DroneSettings
from drone.fire_state import DroneState


class DroneControllerOne(object):
    ...
    def __init__(self, forest: CellularAutomaton, settings: DroneSettings):
        ...
        self.drones = [
            FireDrone(x, settings.drone_speed, settings.location['x'], settings.location['y']) for x in
